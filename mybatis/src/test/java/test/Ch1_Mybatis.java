...
public class Ch1_Mybatis {
    ...
    public void testSelect() throws IOException {
        ...
        try{
            ...
            Employee employee1 = sqlSession.selectOne("xyz.wecloud.mybatis.mapper.EmployeeMapper.selectEmployeeById", 1);
            Employee employee2 = sqlSession.selectOne("xyz.wecloud.mybatis.mapper.EmployeeMapper.selectEmployeeById", 1);
            ...
            Employee employee3 = sqlSession.selectOne("xyz.wecloud.mybatis.mapper.EmployeeMapper.selectEmployeeById", 1);
            ...
            // 结果返回非同一对象
            Employee employee4 = sqlSession.selectOne("xyz.wecloud.mybatis.mapper.EmployeeMapper.selectEmployeeById", 1);
